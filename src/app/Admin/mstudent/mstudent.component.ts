...
export class MstudentComponent implements OnInit {
    ...
    fetchstan() {
        this.http.get("https://cooing-famous-iguanacolossus.glitch.me/Admin/Student").subscribe((data: any) => {
                        ...
                        Is_Active: {
                            ...
                            onComponentInitFunction(instance) {
                                instance.save.subscribe((data: any) => {
                                    that.http.put("https://cooing-famous-iguanacolossus.glitch.me/Admin/Student", { _id: data.rowdata._id, Is_Active: data.value }).subscribe((data: any) => {
                                        console.log(data)
                                        if (data.Error) {
    ...
    onDeleteConfirm(event) {
        ...
        swal.fire({
            ...
            if (data.dismiss === swal.DismissReason.cancel) {
                ...
                that.http.delete("https://cooing-famous-iguanacolossus.glitch.me/Admin/Student?_id=" + event.data._id).subscribe((data: any) => {
                    if (data.Error) {
                        that.toast.error(data.Error);
                    } else {
